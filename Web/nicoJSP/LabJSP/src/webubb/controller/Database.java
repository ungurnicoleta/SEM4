...
public class Database {
    ...
    public Database() {
        ...
        this.connString = "jdbc:postgresql://localhost:5432/DB_JSP";
        this.user = "nicoletaungur";
        this.pass = "test";
    }
    ...
    public void updateScore(int value) {
        try {
            PreparedStatement pStmt = this.con.prepareStatement( "UPDATE puzzle SET position = ? WHERE id = ?");
            pStmt.setInt(1, n * n - 1);
